...
export default function CardapioScreen() {
  const { comandaId, mesa_numero } = useLocalSearchParams();
  ...
  return (
    <View style={s.container}>
      <View style={s.header}>
        <TouchableOpacity onPress={() => router.back()}><Text style={s.back}>← Mesa {mesa_numero}</Text></TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  titulo:      { color: '#fff', fontWeight: '700', fontSize: 18 },
